...
<style>
                        ...
                        <div class="main-menu">
                            <ul>
                                ...
                                <li class="menu-item-has-children active"><a
                                        href="#">{{$selected_language->data['website_pages'] ?? 'Pages'}}</a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li>
                                            <a href="{{route('about')}}">{{$selected_language->data['about_us'] ?? 'About Us'}}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{route('termsandcondition')}}">{{$selected_language->data['termsandcondition'] ?? 'Terms and Condition'}}
                                            </a>
                                        </li>
                                        <li>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6" style="margin-top: 65px;">
                        ...
                        <p class="rt-mb-0">
                            ...
                            <br>
                            2. {{$selected_language->data['see_a_demo_menu_point2'] ?? 'Scroll around the menu and make your order.'}}
                            <br>
    ...
    <section class="testimonials-area rtbgprefix-cover move-parents"
             style="background-image: url(themes/default/images/all-img/section-bg-2.png);">
        <div class="rt-spacer-120 rt-spacer-xs-80"></div>
        <!-- /.rt-spacer-115 -->
        <div class="rt-inner-overlay star-move2 rtbgprefix-cover"
             style="background-image: url(&quot;themes/default/images/banner/banner-star.png&quot;); transform: matrix(1, 0, 0, 1, 69.6526, -61.0776);"></div>
        <!-- /._banner html -->
        <div class="rt-container">
            <div class="row">
                <div class="col-lg-6 mx-auto text-center  text-white" data-wow-duration="1s">
                    <h2 class="rt-section-title">
                        <span>{{$selected_language->data['website_testimonial_head1'] ?? 'What our customers say'}}</span> {{$selected_language->data['website_testimonial_head2'] ?? 'Client’s Feedback Latest Reviews From My Clients'}}
                    </h2>
                </div><!-- /.col-lg-6 mx-auto text-center  text-white -->
            </div><!-- /.row -->
            <div class="rt-spacer-40"></div><!-- /.rt-spacer-40 -->

            <div class="row">
                <div class="col-12">
                    <div class="testimoninal-active-1 owl-carousel owl-loaded owl-drag">

                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                 style="transform: translate3d(-3000px, 0px, 0px); transition: all 0.25s ease 0s; width: 4800px;">
...
{{--start--}}
                                ...
                                <div class="owl-item cloned" style="width: 570px; margin-right: 30px;">
                                    <div class="rt-testimonials-single-item">
                                        <div class="testimonials-header">
                                            <div class="left-item media">
                                                <div class="rt-mr-20">
                                                    <img src="themes/default/images/all-img/testi-2.png" alt=""
                                                         class="rt-circle">
                                                </div>
                                                <div class="media-body">
                                                    <h4 class="f-size-18 rt-strong">{{$testimonials->name}}</h4>
                                                    <span class="d-block">{{$testimonials->designation}}</span>
                                                </div>
                                            </div>
                                            <div class="right-item">
                                                <img src="themes/default/images/all-img/testi-icon-2.png" alt=""
                                                     draggable="false">
                                            </div>
                                        </div>
                                        <div class="testimonials-text-content">
                                            <p class="testimonials-text-new">
                                                {{$testimonials->comment}}
                                            </p>
                                            <div class="d-flex justify-content-between rt-mt-15 align-items-center">
                <span class="review">


                </span>
                                                <span class="quteo"><img src="themes/default/images/all-icon/q2.png"
                                                                         alt=""></span>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                end--}}
        ...
        <!-- /.rt-container -->
        <div class="rt-spacer-220 rt-spacer-xs-160"></div>
        <!-- /.rt-spacer-115 -->
    </section>
            ...
            <div class="col-lg-3 col-md-6 mx-auto rt-mb-30">
                <div class="rt-single-icon-box icon-center  wow fade-in-bottom bg-transparent text-center  animated"
                    ...
                    <div class="iconbox-content">
                        ...
                        <p class="f-size-15 line-height-26 rt-mb-0">{{$selected_language->data['register_footer_subtitle'] ?? 'Create Account to get started.'}}
                        </p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 rt-mb-md-20">
                            <div class="media">
                                ...
                                <div class="media-body text-white">
                                    <span
                                        class="d-block rt-mb-8 rt-light3 ">{{$selected_language->data['give_us_call'] ?? 'Give us a Call'}}</span>
                        ...
                        <div class="col-lg-4 rt-mb-md-20">
                            <div class="media">
                                ...
                                <div class="media-body text-white">
                                    <span
                                        class="d-block rt-mb-8 rt-light3 ">{{$selected_language->data['send_us_message'] ?? 'Send us a Message'}}</span>
                                    <p class="rt-mb-0 f-size-18 rt-strong">
                        ...
                        <div class="col-lg-4">
                            <div class="media">
                                ...
                                <div class="media-body text-white">
                                    <span
                                        class="d-block rt-mb-8 rt-light3 ">{{$selected_language->data['visit_our_location'] ?? 'Visit our Location'}}</span>
                                    <p class="rt-mb-0 f-size-18 rt-strong">
