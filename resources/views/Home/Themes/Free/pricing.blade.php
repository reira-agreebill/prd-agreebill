            ...
            <div class="row rt-breadcump-height align-items-center">
                <div class="col-lg-8 mx-auto text-center">
                    <div class="inner-content">
                        <h3> {{$selected_language->data['pricing_head_title'] ?? 'Choose The Best Plan For Your Business'}}</h3>
                ...
                <div class="col-lg-4 col-md-6 mx-auto rt-mb-30 wow fade-in-bottom">
                    <div class="rt-price-1 color_3">
                        ...
                        <div class="price-footer text-center">
                            <a href="{{route('store_register')}}" class="rt-btn rt-gradient4 pill text-uppercase rt-Bshadow-2">
                                {{$selected_language->data['pricing_start_button'] ?? 'Start'}}
